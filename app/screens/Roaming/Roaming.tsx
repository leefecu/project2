...
import Styles from './Roaming.styles';
  ...
  render() {
    return (
      <View style={Styles.container}>
        ...
        <View style={Styles.icon} {...testProps('Roaming Lock Icon')}>
          <LockSVG />
        </View>
        ...
        <View style={Styles.textRow}>
          <Text style={Styles.message}>You can only use the Data Clock app in New Zealand.</Text>
        </View>
      </View>
    );
  }
